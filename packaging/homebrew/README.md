...
wand ships through the personal tap at
[`akira-toriyama/homebrew-tap`](https://github.com/akira-toriyama/homebrew-tap)
as `Formula/wand.rb`. The file in
[`wand.rb`](wand.rb) here is the **reference copy** — it can't carry
...
sed -i -E "s|archive/refs/tags/v[0-9]+\.[0-9]+\.[0-9]+\.tar\.gz|archive/refs/tags/${TAG}.tar.gz|g" Formula/wand.rb
sed -i -E "s|sha256 \"[0-9a-f]{64}\"|sha256 \"${SHA}\"|g"                                            Formula/wand.rb
